    ...
    return (
        <View style={styles.view}>
            ...
            <View style={styles.titleView}>
                ...
                <SvgXml onPress={() => { setTrashDialogVisible(true) }} xml={trashSVG} width="13%" height="100%" />
            </View>
            {/* REMAINING CALORIES */}
            ...
            <Dialog.Container visible={trashDialogVisible} onBackdropPress={() => {setTrashDialogVisible(false)}} useNativeDriver={true}>
                <Dialog.Title>Are you sure?</Dialog.Title>
                <Dialog.Button label="Cancel" onPress={() => setTrashDialogVisible(false)} />
                <Dialog.Button label="Proceed" onPress={() => handleTrashSVGPress()} />
            </Dialog.Container>
        </View>
    );
}
...
function TitleBar(props)
{
    ...
    return (
        <View style={styles.view}>
            ...
            <View style={styles.settingsSVGView}>
